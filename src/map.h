...
typedef DynaArray<ComplexPointsSegment> ComplexPointsSegmentList;
typedef ComplexPointsSegmentList* pComplexPointsSegmentList;
typedef ComplexPointsSegmentList& rComplexPointsSegmentList;
...
// Maps points 'from' -> 'to' using 'map'. ErrorObj returns status.
// MapPoints returns cTRUE if the mapping went ok, cFALSE otherwise.
bool MapPoints(const rComplexPointsSegmentList from, rComplexPointsSegmentList to,
	       pCodeSegment map, rErrorObj);
